...
```bash
docker pull takuphilchan/offgrid-llm:0.4.11
...
docker run -d \
  ...
  takuphilchan/offgrid-llm:0.4.11
```
...
`0.4.11-gpu` tag (Linux AMD64). The `edge` tag is for development, not a stable
upgrade channel. See [Docker deployment](docs/setup/docker.md) and the
[v0.4.11 release notes](docs/releases/release-notes-v0.4.11.md).
