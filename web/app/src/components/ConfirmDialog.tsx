...
export function ConfirmDialog({ title, body, confirm, close, confirmLabel }: { title: string; body: string; confirm: () => Promise<void>; close: () => void; confirmLabel?: string }) {
