export type Messages = {
  ...
  chat: { title: string; subtitle: string; emptyTitle: string; emptyBody: string; placeholder: string; send: string; stop: string; knowledge: string; model: string; selectModel: string; you: string; assistant: string };
  ...
  models: { title: string; subtitle: string; available: string; empty: string; local: string; embedding: string };
